...
<html lang="en">
    ...
    <!-- Mirrored from bootstrap.gallery/unipro/v1-x/01-design-blue/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 11:44:39 GMT -->
    <head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                                ...
                                <div class="login-screen">
                                    <div class="login-body">
                                        ...
                                        <div class="field-wrapper">
                                            <input type="text" autofocus name="mobile">
    ...
    <!-- Mirrored from bootstrap.gallery/unipro/v1-x/01-design-blue/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 11:44:40 GMT -->
</html>